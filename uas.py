...
if pilihan_user == 1 : 
    ...
    df_a_print.plot(x='Tahun', y='Produksi', title= "Grafik Jumlah Produksi Minyak Mentah terhadap Waktu (tahun) dari Suatu Negara", color='purple', linestyle='dashed', linewidth = 3,
         marker='o', markerfacecolor='pink', markersize=9)
...
#tahun_b= int(input("Produksi pada Tahun berapa:"))
    ...
    df_b_print.plot.bar(x='Nama Negara', y='Produksi', title = "Grafik Jumlah Produksi terbesar" , width = 0.8, color = ['purple', 'pink'])
...
if pilihan_user == 3 : 
    ...
    df_c_sort.plot.bar(x='Nama Negara', y='Produksi Kumulatif', title = "Grafik Produksi Jumlah Kumulatif Terbesar", width = 0.8, color = ['black'])
    grafik_c = plt.show()
    st.pyplot(grafik_c)
